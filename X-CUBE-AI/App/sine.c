...
#define AI_SINE_MODEL_SIGNATURE     "0xfc19bd00040282cf0a9574b786686fc4"
...
#define AI_TOOLS_DATE_TIME   "2024-10-15T12:33:31+0200"
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_sine_activations_map, 1, params)) {
    ...
    serving_default_dense_input0_output_array.data = AI_PTR(g_sine_activations_map[0] + 60);
    serving_default_dense_input0_output_array.data_start = AI_PTR(g_sine_activations_map[0] + 60);
    gemm_0_output_array.data = AI_PTR(g_sine_activations_map[0] + 64);
    gemm_0_output_array.data_start = AI_PTR(g_sine_activations_map[0] + 64);
    nl_0_nl_output_array.data = AI_PTR(g_sine_activations_map[0] + 64);
    nl_0_nl_output_array.data_start = AI_PTR(g_sine_activations_map[0] + 64);
    ...
    nl_1_nl_output_array.data = AI_PTR(g_sine_activations_map[0] + 64);
    nl_1_nl_output_array.data_start = AI_PTR(g_sine_activations_map[0] + 64);
    gemm_2_output_array.data = AI_PTR(g_sine_activations_map[0] + 0);
    gemm_2_output_array.data_start = AI_PTR(g_sine_activations_map[0] + 0);
    return true;
  }
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_sine_weights_map, 1, params)) {
    ...
    gemm_0_bias_array.data = AI_PTR(g_sine_weights_map[0] + 64);
    gemm_0_bias_array.data_start = AI_PTR(g_sine_weights_map[0] + 64);
    gemm_1_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_1_weights_array.data = AI_PTR(g_sine_weights_map[0] + 128);
    gemm_1_weights_array.data_start = AI_PTR(g_sine_weights_map[0] + 128);
    gemm_1_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_1_bias_array.data = AI_PTR(g_sine_weights_map[0] + 1152);
    gemm_1_bias_array.data_start = AI_PTR(g_sine_weights_map[0] + 1152);
    gemm_2_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_weights_array.data = AI_PTR(g_sine_weights_map[0] + 1216);
    gemm_2_weights_array.data_start = AI_PTR(g_sine_weights_map[0] + 1216);
    gemm_2_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_bias_array.data = AI_PTR(g_sine_weights_map[0] + 1280);
    gemm_2_bias_array.data_start = AI_PTR(g_sine_weights_map[0] + 1280);
    return true;
  }
