...
#define AI_SINE_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_SINE_IN_1_CHANNEL     (1)
#define AI_SINE_IN_1_SIZE        (1)
#define AI_SINE_IN_1_SIZE_BYTES  (4)
...
#define AI_SINE_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_SINE_OUT_1_CHANNEL     (1)
#define AI_SINE_OUT_1_SIZE        (1)
#define AI_SINE_OUT_1_SIZE_BYTES  (4)
