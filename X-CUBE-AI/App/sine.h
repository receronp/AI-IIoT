...
#define AI_SINE_ORIGIN_MODEL_NAME   "hello_world_int8"

/******************************************************************************/
#define AI_SINE_ACTIVATIONS_ALIGNMENT   (4)
#define AI_SINE_INPUTS_IN_ACTIVATIONS   (4)
#define AI_SINE_OUTPUTS_IN_ACTIVATIONS  (4)
...
AI_DEPRECATED
#define AI_SINE_IN \
  ai_sine_inputs_get(AI_HANDLE_NULL, NULL)
...
#define AI_SINE_IN_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_SINE_IN_1_CHANNEL     (1)
#define AI_SINE_IN_1_SIZE        (1)
#define AI_SINE_IN_1_SIZE_BYTES  (1)
...
AI_DEPRECATED
#define AI_SINE_OUT \
  ai_sine_outputs_get(AI_HANDLE_NULL, NULL)
...
#define AI_SINE_OUT_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_SINE_OUT_1_CHANNEL     (1)
#define AI_SINE_OUT_1_SIZE        (1)
#define AI_SINE_OUT_1_SIZE_BYTES  (1)

/******************************************************************************/
#define AI_SINE_N_NODES (3)
